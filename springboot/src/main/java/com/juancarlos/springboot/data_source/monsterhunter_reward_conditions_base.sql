...
--
-- Table structure for table `reward_conditions_base`
--

DROP TABLE IF EXISTS `reward_conditions_base`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `reward_conditions_base` (
