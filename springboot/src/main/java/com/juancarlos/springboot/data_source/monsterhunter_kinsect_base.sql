...
--
-- Table structure for table `kinsect_base`
--

DROP TABLE IF EXISTS `kinsect_base`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `kinsect_base` (
  `id` int NOT NULL,
  `name` varchar(100) DEFAULT NULL,
  `previous` varchar(100) DEFAULT NULL,
  `rarity` int DEFAULT NULL,
  `attack_type` varchar(100) DEFAULT NULL,
  `dust_effect` varchar(100) DEFAULT NULL,
