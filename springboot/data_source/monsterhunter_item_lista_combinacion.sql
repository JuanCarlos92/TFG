...
--
-- Table structure for table `item_lista_combinacion`
--

DROP TABLE IF EXISTS `item_lista_combinacion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `item_lista_combinacion` (
  `id` int NOT NULL,
  `nombre_resultado` varchar(100) DEFAULT NULL,
  `primero` varchar(100) DEFAULT NULL,
